...
<template>
  <div
    class="tw-fixed tw-left-0 tw-right-0 tw-top-0 tw-h-[4.25rem] tw-bg-violet-400 tw-px-4 tw-shadow dark:tw-bg-zinc-900"
  >
    <div class="tw-flex tw-h-full tw-items-center tw-justify-around">
      <v-img src="~/public/logo-text.png" height="42" width="162"></v-img>
      <div
        class="tw-relative tw-flex tw-h-full tw-w-full tw-items-center tw-justify-between"
      >
        <div>
